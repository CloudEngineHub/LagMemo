...
from lagmemo.core.interfaces import (
    ContinuousNavigationAction,
    DiscreteNavigationAction,
)
from lagmemo.utils.geometry import xyt_global_to_base
from lagmemo.utils.spot import angular_distance_from_angle
...
class DiscretePlanner:
    ...
    def _get_short_term_goal(
        ...
        if discrete_long_term_goal:
            ...
            replan = False
            stop = False
            closest_goal_pt = (int(long_term_goal[0]), int(long_term_goal[1]))
